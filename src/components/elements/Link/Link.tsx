...
export function Link({
  ...
  const className =
    Component === 'a'
      ...
      : 'uppercase py-2 my-2 px-4 md:mt-16 bg-transparent text-gray-800 bg-white hover:bg-gray-100 border-2 border-gray-800 text-gray-800 transition ease-in-out hover:-translate-y-1 hover:scale-105 text-md'
